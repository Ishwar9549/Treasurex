 ...
 * custom forbidden handling, and password encoding.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfiguration {
	 ...
	 * etc.) - Requires authentication for other endpoints - Adds JWT filter before
	 * UsernamePasswordAuthenticationFilter - Stateless session management
	 */
	@Bean
