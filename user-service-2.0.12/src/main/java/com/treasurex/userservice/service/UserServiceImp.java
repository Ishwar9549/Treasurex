...
public class UserServiceImp implements UserService {
	...
	public ApiResponse<Map<String, String>> sendForgotOtpToEmail(EmailRequest request) {
		...
		// Generate JWT token for verification step
		String token = jwtUtil.generateToken(user.getPhoneNumber(), JwtPurpose.FORGOT_PASSWORD_VERIFY_EMAIL, null);
	...
	public ApiResponse<Map<String, String>> verifyForgotEmail(String authorizationHeader, OtpVerifyRequest request) {
		...
		// Generate token for next step
		String token = jwtUtil.generateToken(user.getPhoneNumber(), JwtPurpose.FORGOT_PHONE, null);
	...
	public ApiResponse<Map<String, String>> sendForgotOtpToPhone(String authorizationHeader,
		...
		User user = validateTokenAndGetUser(authorizationHeader, JwtPurpose.FORGOT_PHONE);
		...
		// Generate JWT token for verification step
		// Generate token for next step
		String token = jwtUtil.generateToken(user.getPhoneNumber(), JwtPurpose.FORGOT_PASSWORD_VERIFY_PHONE, null);
	...
	public ApiResponse<Map<String, String>> verifyForgotPhone(String authorizationHeader, OtpVerifyRequest request) {
		...
		// Extract purpose from JWT // Get user from token
		User user = validateTokenAndGetUser(authorizationHeader, JwtPurpose.FORGOT_PASSWORD_VERIFY_PHONE);
