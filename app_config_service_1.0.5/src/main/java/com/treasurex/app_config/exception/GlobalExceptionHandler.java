...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Map<String, Object>> resourceConflictException(ResourceConflictException ex) {
		log.error("Resource Conflict Exception caught: {}", ex.getMessage());
		Map<String, Object> body = new HashMap<>();
